...
export const COMPETENCIES = [
  ...
  { id: 'it_technical', name: 'IT 기술 전문성', description: 'IT분야에 관심도 및 관련 전문성 수준은 어느 정도인가요?\n(1점: 관련 지식 전무 or 흥미 없음 ~ 5점: 관심도가 높으며 복잡한 프로그래밍 혹은 시스템 설계 가능)' },
  { id: 'mfg_technical', name: '제조/공학 전문성', description: '제조나 공학 분야에서 본인의 전문 지식과 경험 수준은 어느 정도인가요?\n(1점: 지식 전무 혹은 기초적인 이해 수준 ~ 5점: 특정 공학 분야에서의 심화된 전문 지식 보유)' },
